...
export const PaymentPage = () => {
  ...
  if (!movie || !bookingData) return null
            ...
            <div className="space-y-6">
                  ...
                  <div className="space-y-3 text-sm text-gray-600">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1">All transactions are encrypted</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="mt-0.5">
                      ...
                      <div>
                        ...
                        <p className="mt-1">Highest security standards</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="mt-0.5">
                      ...
                      <div>
                        ...
                        <p className="mt-1">Cards, UPI, Net Banking</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <Card className="border-0 shadow-sm">
                <div className="p-6">
                  ...
                  <div className="space-y-3 text-sm text-gray-600">
                    <p>For payment queries, contact our customer support.</p>
